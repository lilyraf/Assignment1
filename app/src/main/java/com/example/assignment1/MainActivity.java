...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCalcDet = findViewById(R.id.tvCalcDet);
        tvTcharge = findViewById(R.id.tvTcharge);
        tvFcharge = findViewById(R.id.tvFcharge);
        tvFcharge2 = findViewById(R.id.tvFcharge2);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.btnConvert:
                calcCharges();//call function to calculate
                break;
            case R.id.btnClear:
                clearFields();//call function to clear
                break;
        }
    }
    ...
    private void calcCharges(){
        try {
            ...
            // Handle the exception when the input is bigger than 5
